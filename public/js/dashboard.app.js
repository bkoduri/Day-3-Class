var dashboardApp = new Vue({
  ...
  methods: {
    ...
    fetchTasks () {
      fetch('https://raw.githubusercontent.com/tag/iu-msis/app/data/public/p1-tasks.json')
    ...
    fetchProject () {
      fetch('https://raw.githubusercontent.com/tag/iu-msis/app/data/public/project1.json')
      .then( response => response.json() )
